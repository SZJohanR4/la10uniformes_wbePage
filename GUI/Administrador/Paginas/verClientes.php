...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" style="color: white">Tabla Clientes</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                    <form  <f method="post" action="../../../Clases/ControlClientes.php" enctype="multipart/form-data" >
                                            <?php
                                            ...
                                            $resulta = mysql_query("SELECT * FROM usuarios WHERE rol= 'CLIENTE';", $link);


                                            while ($row = mysql_fetch_row($resulta)) {
                                                $consul = $row[0];
                                                $result = mysql_query("select * from usuarios where idUsuario= " . $consul . ";");
...
//                                                    echo"<td>" . $fila[0] . "</td>";
                                                    ...
                                                    echo"<td><input type=submit name=Eliminar value= " . $fila[0] . ".Eliminar id= Eliminar></td>";
