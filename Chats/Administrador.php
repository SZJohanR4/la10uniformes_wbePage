<?php
    ...
    <a href="../Administrador.php"><h1>Pagina Principal </h1></a>
                        ...
                        <tr> 
                            <td> 
                                ...
                                <div id="sala" style="visibility:none; display:none; overflow:auto; height:270px;"> 
                                    <div class="sala_ac" sala="Cliente">Cliente </div> 
                                    <div class="sala" sala="Administrador">Proveedor</div> 
